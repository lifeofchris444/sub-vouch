...
import { ArrowRight, Gift, Sparkles, UtensilsCrossed } from "lucide-react";
  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-10 pb-14 sm:pt-14 sm:pb-18 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#00983C] rounded-3xl p-7 sm:p-10 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <div className="w-2 h-2 bg-[#00983C] rounded-full animate-pulse" />
            ...
            >
              Join thousands of diners who have already claimed their $100 reward. Your next meal is just a few clicks away.
            </p>
            ...
            >
              <a
                ...
                className="touch-button group inline-flex items-center gap-3 bg-white text-[#00983C] px-10 py-5 rounded-full text-lg font-semibold hover:bg-white/90 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
              >
                APPLY NOW
